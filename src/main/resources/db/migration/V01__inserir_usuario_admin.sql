...
insert into usuario (nome, email, senha, ativo, codigo_grupo) values ('Administrador', 'admin@localhost', '$2a$10$VG0VxfwUKhzGZn7R7NWa9e0qA/jv03tCbs.9DADeb0KWcmQPRzEnS', 1, 1);
