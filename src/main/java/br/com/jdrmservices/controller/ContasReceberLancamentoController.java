...
public class ContasReceberLancamentoController {
	...
	@GetMapping
	public ModelAndView pesquisar(ContaReceberLancamentoFilter contareceberlancamentoFilter, BindingResult result, @PageableDefault(size = 10) Pageable pageable) {
